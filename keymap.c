 ...
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  Esc   |   !  |   @  |   #  |   $  |   %  | Enter|           |      |   ^  |   &  |   *  |   (  |   )  |  CAPS  |
 * |  Esc   |   1  |   2  |   3  |   4  |   5  | Enter|           |      |   6  |   7  |   8  |   9  |   0  |  CAPS  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |    `   |   Q  |   W  |   F  |   P  |   G  | Del  |           | L2   |   J  |   L  |   U  |   Y  |   ;  |   -    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |  Tab   |   A  |   R  |   S  |   T  |   D  |------|           |------|   H  |   N  |   E  |   I  |   O  | Enter  |
 * |--------+------+------+------+------+------| L1   |           | L1   |------+------+------+------+------+--------|
 * |   '    |   Z  |   X  |   C  |   V  |   B  |      |           |      |   K  |   M  |   ,  |   .  |  /   |   \    |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  Up  | Down | Left | Right| Back |                                       | Space| Up   | Down |  =   |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,--------------.
 *                                        | Lclk | Rclk |       | WhlD | WhlU |
 *                                 ,------|------|------|       |------+-------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        // KC_ESC,         KC_EXLM,      KC_AT,   KC_HASH, KC_DLR, KC_PERC, KC_ENT,
        KC_GRV,         KC_Q,         KC_W,    KC_F,    KC_P,   KC_G,    KC_DELT,
        ...
        // right hand
             ...
             MO(SYMB),    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,    KC_BSLS,
...
//        // left hand
//        KC_NO,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_NO,
//        KC_NO,   KC_NO,   KC_NO,   KC_LBRC, KC_RBRC, KC_NO,   KC_INS,
//        KC_NO,   KC_NO,   KC_NO,   KC_LPRN, KC_RPRN, KC_NO,
//        KC_NO,   KC_NO,   KC_NO,   KC_LCBR, KC_RCBR, KC_NO,   KC_NO,
//        KC_NO,   KC_NO,   KC_HOME, KC_END,  KC_NO,
//                                         KC_NO,   KC_NO,
//                                                  KC_TRNS,
//                                KC_TRNS, KC_TRNS, KC_TRNS,
//        // right hand
//        KC_NO,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
//        KC_NO,   KC_NO,   KC_7,    KC_8,    KC_9,    KC_0,    KC_F12,
//                 KC_MINS, KC_4,    KC_5,    KC_6,    KC_DOT,  KC_ENT,
//        KC_NO,   KC_NO,   KC_1,    KC_2,    KC_3,    KC_SLSH, KC_ASTR,
//                          KC_PLUS, KC_PGUP, KC_PGDN, KC_EQL,  KC_NO,
//        KC_NO,   KC_NO,
//        KC_TRNS,
//        KC_TRNS, KC_TRNS, KC_TRNS
// ),
