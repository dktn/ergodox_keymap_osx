 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |    `   |   Q  |   W  |   D  |   P  |   G  | Del  |           | L2   |   J  |   L  |   U  |   H  |   ;  |   -    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |  Tab   |   A  |   R  |   S  |   T  |   Y  |------|           |------|   F  |   N  |   E  |   I  |   O  | Enter  |
 * |--------+------+------+------+------+------| L1   |           | L1   |------+------+------+------+------+--------|
 * |   '    |   Z  |   X  |   C  |   V  |   B  |      |           |      |   K  |   M  |   ,  |   .  |  /   |   \    |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_TAB,         KC_A,         KC_R,    KC_S,    KC_T,   KC_Y,
        ...
        // right hand
             ...
             MO(MDIA),    KC_J,    KC_L,    KC_U,    KC_H,    KC_SCLN,    KC_MINS,
                          KC_F,    KC_N,    KC_E,    KC_I,    KC_O,       KC_ENT,
